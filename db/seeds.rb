...
u1 = User.create(:email => 'tony.contreras@gmail.com', :password => 'a', :password_confirmation => 'a')
u2 = User.create(:email => 'alyfc33@gmail.com', :password => 'a', :password_confirmation => 'a')

e1 = Exercise.create(:activity => 'Run', :value => 3.1, :unit => 'miles' )
e2 = Exercise.create(:activity => 'Hop', :value => 100, :unit => 'reps' )
e3 = Exercise.create(:activity => 'Swim', :value => 60, :unit => 'minutes' )
e4 = Exercise.create(:activity => 'Run', :value => 10, :unit => 'miles' )
e5 = Exercise.create(:activity => 'Run', :value => 4, :unit => 'miles' )
